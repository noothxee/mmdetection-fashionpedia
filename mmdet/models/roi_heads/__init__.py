...
from .atr_heads import (AttributeHead, ConvFCAtrHead, Shared2FCAtrHead, Shared4Conv1FCAtrHead)
...
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead', 'AttributeHead', 'ConvFCAtrHead', 'Shared2FCAtrHead', 
    'Shared4Conv1FCAtrHead'
]
